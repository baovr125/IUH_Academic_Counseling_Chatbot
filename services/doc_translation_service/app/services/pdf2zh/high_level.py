...
def translate_stream(
    ...
    **kwarg: Any,
    ...
    import os
    font_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), "NotoSans-Regular.ttf")
    noto_name = "noto"
...
def download_remote_fonts(lang: str):
    ...
    # Override to use Times New Roman font if available
    times_font_path = os.environ.get("NOTO_FONT_PATH", r"g:\Khoa_Luan\IUH_Academic_Counseling_Chatbot\services\doc_translation_service\font_word\times.ttf")
    
    if Path(times_font_path).exists():
        font_path = times_font_path
    else:
