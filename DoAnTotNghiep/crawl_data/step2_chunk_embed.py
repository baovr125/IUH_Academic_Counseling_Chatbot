...
input_dir = r"G:\ChatBot\Code\Version1\DowLoad_Data\markdown_crawl_output_v3" 
FILE_EXTENSION = ".md"

# Nơi lưu kết quả Giai đoạn 3
output_dir = r"G:\ChatBot\Code\Version1\chatbox_IUH\data_json1"
...
def embed_and_save_faiss(all_children, model_name):
    if not all_children:
        print("⚠️ Không có children nào để embed.")
        return
